...
{
    // Same accreted discount rules the business has depended on since 2016.
    // Integer truncation and the VIP/top-tier interaction are load-bearing legacy
    // behavior: characterization tests pin them exactly (kit decision D-001).
    public class PricingService
    {
        public PricingResult Price(IList<OrderLine> lines, string promoCode)
        {
            ...
            // Quirk: VIP was never made stackable with the top tier.
